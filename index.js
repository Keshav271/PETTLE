...
async function getVal() {
    ...
    try{
        ...
        if(res.data.Normal == "yes" && res.data.Schizophrenia == "no" && res.data.Suicidal == "no"){
            modalBody.innerHTML = "Hey, we didn't find any traces of Schizophrenia, Anxiety or Depression, just stay hydrated."
        } else {
  ...
  async function getPredfromText(paragraph){
      try{
        ...
        if(textres.data.Normal == "yes" && textres.data.Schizophrenia == "no" && textres.data.Suicidal == "no"){
            modalBody.innerHTML = "Hey, we didn't find any traces of Schizophrenia, Anxiety or Depression, just stay hydrated, you're fine."
        } else {
